...
lte_plasma = plasma.LTEPlasma.from_abundance(1000, {'Si': 1}, 1e-13, atom_data, 10.)
...
plot(t_rads, siI, 'b-', label='Si I')
plot(t_rads, siII, 'g-', label='Si II')
plot(t_rads, siIII, 'r-', label='Si III')
plot(t_rads, siIV, 'k-', label='Si IV')
