...
These tests require regression data files against which the results of the various
tardis runs are tested. So you first need to either download the current
regression data files (`here <https://github.com/tardis-sn/tardis-regression-data>`_)
...
use very few packets to generate the regression data and thus make the process much
