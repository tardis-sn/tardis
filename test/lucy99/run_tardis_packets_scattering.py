...
ax.set_title('Input vs Output (Nebular Plasma & Scattering)')

fig.savefig('tardis_nebular_scatter_in_vs_out.pdf')
fig.savefig('tardis_nebular_scatter_in_vs_out.png')
