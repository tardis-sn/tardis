...
from astropy_helpers.setup_helpers import (register_commands, adjust_compiler, 
                                           ...
                                           add_command_option, get_distutils_option)
...
add_command_option('develop', 'with-vpacket-logging', 'compile TARDIS with virtual packet logging',
                   is_bool=True)
add_command_option('install', 'with-continuum-interactions', 'compile TARDIS with continuum interactions',
                   is_bool=True)
add_command_option('build', 'with-continuum-interactions', 'compile TARDIS with continuum interactions',
                   is_bool=True)
add_command_option('develop', 'with-continuum-interactions', 'compile TARDIS with continuum interactions',
                   is_bool=True)
...
package_info['package_data'][PACKAGENAME].append('continuum/data/*')
...
compile_time_env = {'WITH_CONTINUUM': False}
if get_distutils_option('with_continuum_interactions', ['build', 'install', 'develop']) is not None:
    compile_time_env['WITH_CONTINUUM'] = True

package_info['ext_modules'] = cythonize(package_info['ext_modules'], compile_time_env=compile_time_env, force=True)
