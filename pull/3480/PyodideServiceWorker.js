const appName = 'tardis'
const appCacheName = 'tardis-latest';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.7.1/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
