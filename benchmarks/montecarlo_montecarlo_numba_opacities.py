...
class BenchmarkMontecarloMontecarloNumbaOpacities(BenchmarkBase):
    ...
    def time_photoabsorption_opacity_calculation(self, ejecta_density, energy, iron_group_fraction):
    ...
    def time_pair_creation_opacity_calculation(self, ejecta_density, energy, iron_group_fraction):
