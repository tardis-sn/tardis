/* This file was generated automatically with transmutagen version 1.1.0+2.g772e41d.dirty. */
/* The command used to generate this file was: python -m transmutagen.gensolve --py-solve --namespace=pyne_cram --outfile=cram.c --gnu-asm --clang-asm --tar*/
