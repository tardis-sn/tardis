#  tests for h5py-3.11.0-nompi_py310hf054cd7_102 (this is a generated file);
print('===== testing package: h5py-3.11.0-nompi_py310hf054cd7_102 =====');
...
print('===== h5py-3.11.0-nompi_py310hf054cd7_102 OK =====');
print("import: 'h5py'")
import h5py
