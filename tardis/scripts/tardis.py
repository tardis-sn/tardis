...
parser.add_argument(
    "spectrum_fname",
    help="path where to write the output spectrum to. If a virtual spectrum is "
...
parser.add_argument(
    "--log_file",
    default=None,
    help="Name of the log file " "(not implemented yet)",
)

parser.add_argument(
    "--packet_log_file",
    default=None,
    help="Name of the packet log file. Packet logging needs to be switched on before "
    "compiling.",
)
...
parser.add_argument(
    "--profile",
    action="store_true",
    help="run tardis in profiling mode and output results to a specified log file",
)
parser.add_argument(
    "--profiler_log_file",
    default="profiler.log",
    help="name of the profiler output file",
)
