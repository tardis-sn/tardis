...
helium_numerical_nlte_properties = PlasmaPropertyCollection([
    HeliumNumericalNLTE])
detailed_j_blues_inputs = PlasmaPropertyCollection([JBluesEstimator, RInner,
                                                    TInner, Volume])
...
continuum_interaction_inputs = PlasmaPropertyCollection(
    [StimRecombRateCoeffEstimator, PhotoIonRateCoeffEstimator, RInner, TInner,
     Volume, BfHeatingRateCoeffEstimator, YgData]
)
continuum_interaction_properties = PlasmaPropertyCollection(
    [PhotoIonizationData, SpontRecombRateCoeff, PhotoIonRateCoeff,
     ...
     MarkovChainTransProbs, YgInterpolator, CollExcRateCoeff,
     CollDeexcRateCoeff, BaseCollisionTransProbs, MarkovChainIndex,
     MarkovChainTransProbsCollector, FreeFreeCoolingRate, FreeBoundCoolingRate,
     BoundFreeOpacity, LevelNumberDensityLTE, PhotoIonBoltzmannFactor,
     FreeBoundEmissionCDF, LevelIdxs2LineIdx]
)
