...
class Radial1DModel(object):
    ...
    def simulate(self, update_radiation_field=True, enable_virtual=False, initialize_j_blues=False,
        ...
        self.last_line_interaction_full = pd.DataFrame(last_line_interaction_full, index=last_line_interaction_full[:,0], columns=['packet_id','nu','energies', 'last_line_interaction_in_id', 'last_line_interaction_out_id', 'last_line_interaction_in_line_id', 'last_line_interaction_out_line_id', 'emitted'])
