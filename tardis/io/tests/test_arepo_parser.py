...
def get_line_csvy_model():
    ...
    testfile = profile.export(20, os.path.join(DATA_PATH, 'arepo_parser_test.csvy'))
...
def get_line_reference_data():
    with open(os.path.join(DATA_PATH, 'arepo_line_reference_model.csvy'), 'r') as file:
        data = file.readlines()
...
def get_cone_reference_data():
    with open(os.path.join(DATA_PATH, 'arepo_cone_reference_model.csvy'), 'r') as file:
        data = file.readlines()
...
def get_full_reference_data():
    with open(os.path.join(DATA_PATH, 'arepo_full_reference_model.csvy'), 'r') as file:
        data = file.readlines()
