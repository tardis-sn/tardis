...
def transport_to_dict(transport):
    ...
    transport_dict = {
        "Edotlu_estimator": transport.transport_state.estimators.Edotlu_estimator,
        "bf_heating_estimator": transport.transport_state.estimators.bf_heating_estimator,
        "j_blue_estimator": transport.transport_state.estimators.j_blue_estimator,
        "j_estimator": transport.transport_state.estimators.j_estimator,
        "nu_bar_estimator": transport.transport_state.estimators.nu_bar_estimator,
        "stim_recomb_estimator": transport.transport_state.estimators.stim_recomb_estimator,
        "photo_ion_estimator": transport.transport_state.estimators.photo_ion_estimator,
        "photo_ion_estimator_statistics": transport.transport_state.estimators.photo_ion_estimator_statistics,
        "stim_recomb_cooling_estimator": transport.transport_state.estimators.stim_recomb_cooling_estimator,
        ...
        "input_energy": transport.transport_state.packet_collection.initial_energies,
        "input_mu": transport.transport_state.packet_collection.initial_mus,
        "input_nu": transport.transport_state.packet_collection.initial_nus,
        "input_r": transport.transport_state.packet_collection.initial_radii,
        ...
        "spectrum_frequency_cgs": transport.transport_state.spectrum_frequency,
        ...
        "volume": transport.transport_state.geometry_state.volume,
    }
