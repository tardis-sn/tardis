"""
Spectral Element Decomposition (SED) Plot for TARDIS simulation models.
...
class SEDData:
    """The data of simulation model used by Spectral Element Decomposition (SED) Plot.

    This preprocesses the data required by SEDPlotter class for doing
    ...
    def __init__(
        ...
        """
        Initialize the SEDData with required properties of simulation model.
    ...
    def from_simulation(cls, sim, packets_mode):
        """
        Create an instance of SEDData from a TARDIS simulation object.
    ...
    def from_hdf(cls, hdf_fpath, packets_mode):
        """
        Create an instance of SEDData from a simulation HDF file.
...
class SEDPlotter:
    """
    Plotting interface for Spectral Element Decomposition (SED) Plot.

    It performs necessary calculations to generate SED Plot for a simulation
    model, and allows to plot it in matplotlib and plotly.
    """

    def __init__(self, data):
        """
        Initialize the SEDPlotter with required data of simulation model.

        Parameters
        ----------
        data : dict of SEDData
            Dictionary to store data required for SED plot, for both packet
    ...
    def from_simulation(cls, sim):
        """
        Create an instance of SEDPlotter from a TARDIS simulation object.
        ...
        return cls(
            dict(
                virtual=SEDData.from_simulation(sim, "virtual"),
                real=SEDData.from_simulation(sim, "real"),
            )
        )
    ...
    def from_hdf(cls, hdf_fpath):
        """
        Create an instance of SEDPlotter from a simulation HDF file.
        ...
        return cls(
            dict(
                virtual=SEDData.from_hdf(hdf_fpath, "virtual"),
                real=SEDData.from_hdf(hdf_fpath, "real"),
            )
        )
    ...
    def _calculate_emission_luminosities(self, packets_mode, packet_wvl_range):
        """
        Calculate luminosities for the emission part of SED plot.
    ...
    def _calculate_absorption_luminosities(
        ...
        """
        Calculate luminosities for the absorption part of SED plot.
    ...
    def generate_plot_mpl(
        ...
        """
        Generate Spectral Element Decomposition (SED) Plot using matplotlib.
        ...
        show_modeled_spectrum : bool, optional
            Whether to show modeled spectrum in SED Plot. Default value is
            True
        ...
        matplotlib.axes._subplots.AxesSubplot
            Axis on which SED Plot is created
        """
    ...
    def _plot_emission_mpl(self):
        """Plot emission part of the SED Plot using matplotlib."""
    ...
    def _plot_absorption_mpl(self):
        """Plot absorption part of the SED Plot using matplotlib."""
    ...
    def generate_plot_ply(
        ...
        """
        Generate interactive Spectral Element Decomposition (SED) Plot using plotly.
        ...
        plotly.graph_objs._figure.Figure
            Figure object on which SED Plot is created
        """
        # Calculate data attributes required for plotting
        # and save them in instance itself
        self._calculate_plotting_data(
    ...
    def _plot_emission_ply(self):
        """Plot emission part of the SED Plot using plotly."""
    ...
    def _plot_absorption_ply(self):
        """Plot absorption part of the SED Plot using plotly."""
