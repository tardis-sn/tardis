...
PacketsData.__doc__ = (
    """Named tuple to contain data for 'virtual' and 'real' packets"""
)
...
class KromerPlotter:
    ...
    Attributes
    ----------
    R_phot : astropy.units.Quantity having units of cm
        Radius of photosphere
    spectrum_wave : PacketsData, namedtuple of astropy.units.Quantity having units of Angstrom
        Wavelength bins (left edges) in the spectrum made from packets
    spectrum_luminosity : PacketsData, namedtuple of astropy.units.Quantity having units of erg/s
        Luminosity density lambda in each bin of the spectrum made from packets
    t_inner : astropy.units.Quantity having units of K
        Inner temperature
    time_of_simulation : astropy.units.Quantity having units of s
        Time of simulation
    lam_noint : PacketsData, namedtuple of astropy.units.Quantity having units of Angstrom
        Wavelength of the non-interacting packets
    lam_escat : PacketsData, namedtuple of astropy.units.Quantity having units of Angstrom
        Wavelength of the only electron scattering packets
    weights_escat : PacketsData, namedtuple of astropy.units.Quantity having units of erg/s
        Luminosity of the only electron scattering packets
    weights_noint : PacketsData, namedtuple of astropy.units.Quantity having units of erg/s
        Luminosity of the non-interacting packets
    line_in_infos : PacketsData, namedtuple of pd.DataFrame
        Line ids info of the last transitions where packets were absorbed
    line_in_nu : PacketsData, namedtuple of astropy.units.Quantity having units of Hz
        Frequencies of the last transitions where packets were absorbed
    line_in_L : PacketsData, namedtuple of astropy.units.Quantity having units of erg
        Energy values of the last transitions where packets were last absorbed
    line_out_infos : PacketsData, namedtuple of pd.DataFrame
        Line ids info of the last transitions where packets were emitted
    line_out_nu : PacketsData, namedtuple of astropy.units.Quantity having units of Hz
        Frequencies of the last transitions where packets were emitted
    line_out_L : PacketsData, namedtuple of astropy.units.Quantity having units of erg
        Energy values of the last transitions where packets were emitted
   
    Notes
    -----
    PacketsData is a namedtuple having 2 fields 'virtual' and 'real' to
    store data of both modes.
    ...
    def __init__(
        ...
        """Initialize KromerPlotter with required data.

        Parameters
        ----------
        last_interaction_type : PacketsData, namedtuple of np.array
        last_line_interaction_in_id : PacketsData, namedtuple of np.array
        last_line_interaction_out_id : PacketsData, namedtuple of np.array
        last_interaction_in_nu : PacketsData, namedtuple of astropy.units.Quantity having units of Hz
        lines_data : pd.DataFrame
        packet_nus : PacketsData, namedtuple of astropy.units.Quantity having units of Hz
        packet_energies : PacketsData, namedtuple of astropy.units.Quantity having units of erg
        R_phot : astropy.units.Quantity having units of cm
        spectrum_wave : PacketsData, namedtuple of astropy.units.Quantity having units of Angstrom
        spectrum_luminosity : PacketsData, namedtuple of astropy.units.Quantity having units of erg/s
        t_inner : astropy.units.Quantity having units of K
        time_of_simulation : astropy.units.Quantity having units of K
        ...
        # Calculate all the masks that are required for calculating properties
    ...
    def from_simulation(cls, sim):
        """Create KromerPlotter instance from TARDIS Simulation object
    ...
    def from_hdf(cls, hdf_fpath):
        """Create KromerPlotter instance from a simulation HDF file
    ...
    def generate_plot(
        ...
        mode: 'real' or 'virtual'
            The mode of packets to plot (default 'virtual')
        ...
        ylim : tuple or array-like or None
            ...
            scaled (default None)
        nelements : int
            Number of elements to plot (default None)
        twinx : boolean
