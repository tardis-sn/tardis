...
cdef float_type_t move_packet(float_type_t* r, float_type_t* mu,
                              float_type_t nu, float_type_t energy, float_type_t distance,
                              float_type_t* js,
                              float_type_t* nubars,
...
def run_simple_oned(np.ndarray[float_type_t, ndim=1] packets,
    ...
    cdef float_type_t js = 0.0
    cdef float_type_t nubars = 0.0
