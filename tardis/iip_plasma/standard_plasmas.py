...
class LegacyPlasmaArray(BasePlasma):
    ...
    def update_radiationfield(self, t_rad, ws, j_blues, nlte_config,
        ...
        stim_recomb_estimator=None, photo_ion_statistics=None,
        bf_heating_estimator=None, stim_recomb_cooling_estimator=None,
        ff_heating_estimator=None, coll_deexc_heating_estimator=None):
        ...
        self.update(t_rad=t_rad, w=ws, j_blues=j_blues,
                    ...
                    photo_ion_statistics=photo_ion_statistics, bf_heating_estimator=bf_heating_estimator,
    ...
    def __init__(self, number_densities, atomic_data, time_explosion,
        ...
        super(LegacyPlasmaArray, self).__init__(
            ...
            photo_ion_statistics=None, bf_heating_estimator=None,
            stim_recomb_cooling_estimator=None, ff_heating_estimator=None,
