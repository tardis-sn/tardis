...
# code, or it returns the wrong answer.
        ...
        lines_multi_index = pd.MultiIndex.from_arrays(
            [lines.atomic_number, lines.ion_number,
             lines.level_number_lower, lines.level_number_upper]
        )
        return (lines, lines['nu'], lines['f_lu'],
                lines['wavelength_cm'], lines_multi_index)
