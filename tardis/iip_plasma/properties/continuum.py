...
class ThermalBalanceTest(ProcessingPlasmaProperty):
    ...
    def _calculate_coll_ion_heating_balance(
        ...
        _, nu_i, _, collion_coeff = self._get_photo_ion_thermal_data(
            photo_ion_cross_sections
        )
        u0 = (
            nu_i.values
