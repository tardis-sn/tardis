...
from tardis.plasma.properties.base import ProcessingPlasmaProperty, PreviousIterationProperty

from tardis.continuum.util import *

logger = logging.getLogger(__name__)

__all__ = ['LevelNumberDensity', 'LTELevelNumberDensity', 'PhiLucy', 'DepartureCoefficient', 'PreviousDepartureCoefficient']
...
class DepartureCoefficient(ProcessingPlasmaProperty):
    ...
    def calculate(self, phi_lucy, electron_densities, ion_number_density, level_number_density):
