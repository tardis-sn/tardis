...
continuum_inputs = PlasmaPropertyCollection([StimRecombRateEstimator, PhotoIonRateEstimator,
    PhotoIonRateStatistics, ContinuumData, BfHeatingEstimator, StimRecombCoolingEstimator, FfHeatingEstimator,
    CollDeexcHeatingEstimator, YgData])
...
continuum_interaction_properties = PlasmaPropertyCollection([
    SpontRecombRateCoeff, StimRecombRateCoeff, PhotoIonRateCoeff, CollIonRateCoeff, CollRecombRateCoeff])
nlte_ionizaton_properties = PlasmaPropertyCollection([NLTEIonNumberDensity, BfHeatingRateCoeff,
                                                      StimRecombCoolingRateCoeff, PreviousIonNumberDensity,
                                                      CollExcRateCoeff, CollDeexcRateCoeff, PreviousBetaSobolev, BfHeatingRateCoeffEstim,
                                                      DepartureCoefficient, PreviousDepartureCoefficient, PreviousElectronTemperature,
                                                      ThermalBalanceTest,
                                                      CollExcCooling, Yg,
                                                      YgInterpolator])
