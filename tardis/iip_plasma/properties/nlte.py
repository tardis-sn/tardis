...
from tardis.iip_plasma.properties import PhiSahaNebular
...
class PreviousBetaSobolev(PreviousIterationProperty):
    ...
    def set_initial_value(self, kwargs):
        ...
        initial_value = np.ones((lines, len(kwargs["abundance"].columns)))
        self._set_initial_value(initial_value)
...
class PreviousElectronTemperature(PreviousIterationProperty):
    outputs = ("previous_t_electrons",)
