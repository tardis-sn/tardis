...
# 
        ...
        q_ij = self._set_coll_excitation_coeff_index(self.input.q_ij, inplace=False)
    ...
    def _set_coll_excitation_coeff_index(self, coll_excitation_coeff, inplace=True):
...
#
        ...
        rate_coeff = inverse_process.input.coll_recomb_coeff.multiply(inverse_process.electron_densities)
        return rate_coeff
...
#        collion_coeff = collion_coeff.multiply(self.electron_densities / np.sqrt(self.t_electrons), axis=1)
        ...
        collion_coeff = self.input.coll_ion_coeff.multiply(self.electron_densities)
