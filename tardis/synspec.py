...
def get_lambda_spec(nus, energies, wave_min, wave_max, samples=50):
    wave = 1e8 * constants.c / np.array(nus)
    ...
    intens = np.histogram(wave, weights=energies, bins=wavelength_bins)[0]
