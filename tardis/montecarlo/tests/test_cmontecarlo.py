...
# def test_montecarlo_one_packet(clib, packet, model, mt_state):
#     print("Running test_cmontecarlo.py test_montecarlo_one_packet")
#     print("Parameters to /Users/ghost/Desktop/tardis/tardis/montecarlo/tests/test_cmontecarlo.py: ", dir(model), mt_state)
#     print(packet.tau_event)
#     print("clib available?: ", clib.montecarlo_one_packet)
#     clib.montecarlo_one_packet(byref(model), byref(packet), 0, byref(mt_state))
...
#@pytest.mark.skipif(True, reason="Yet to be written.")
def test_montecarlo_main_loop(clib, montecarlo_main_loop_model, mt_state):
    print("Running test_cmontecarlo.py test_montecarlo_one_packet")
    # config = Configuration.from_yaml("/Users/ghost/Desktop/tardis-refdata/configs/examples/tardis_example_2.yml")
    # test_model = Radial1DModel.from_config(config)
    # print("Parameters to /Users/ghost/Desktop/tardis/tardis/montecarlo/tests/test_cmontecarlo.py: ", montecarlo_main_loop_model, clib.montecarlo_main_loop)
    clib.montecarlo_main_loop(byref(montecarlo_main_loop_model), c_int64(0), c_int(0), c_ulong(23111963))
    print("Finished Running test_cmontecarlo.py test_montecarlo_one_packet")
