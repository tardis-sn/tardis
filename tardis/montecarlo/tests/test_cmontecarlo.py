...
def test_montecarlo_main_loop(clib, montecarlo_main_loop_model, mt_state):
    ...
    assert_almost_equal(montecarlo_main_loop_model.output_nus.contents.value, 1124817865250194.8)
    assert_almost_equal(montecarlo_main_loop_model.output_energies.contents.value, 0.10301497824265833)
