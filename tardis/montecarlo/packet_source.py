...
class BlackBodySimpleSource(BasePacketSource):
    ...
    def create_nus(self):
        """
        Creates an array of frequencies associated with packets. Each nu is
        randomly generated by a different random seed, which is also associated
        with a specific packet.

        Outputs:
            :nus: (1D array) array of frequencies associated with packets.
            :mus: (1D array) array of mus associated with packets.
            :energies: (1D array) array of energies associated with packets.
        """
    ...
    def create_mus(self):
        """
        Creates an array of mus associated with packets. Each mu is randomly
        generated by a different random seed, which is also associated with a
        specific packet.
