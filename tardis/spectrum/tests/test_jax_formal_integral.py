...
from tardis.spectrum.formal_integral_jax import reverse_binary_search_jax, line_search_jax, intensity_black_body_jax, populate_z_jax, calculate_z_jax
...
def test_populate_z(ps, tau_sizes, texp, formal_integral_geometry):
    ...
    for i, p in enumerate(ps): 
        ...
        size_z = formal_integral.populate_z(formal_integral_geometry, texp, p, z, shell_id)
        # print(p, z)
        zs_n[i] = z
        sizes_n[i] = size_z
