...
def pytest_addoption(parser):
    ...
    parser.addoption("--update-reference-plasma",
                     default=False,
                     help="Update reference_data for plasma tests")
    parser.addoption("--compare-reference-plasma",
                     default=False,
                     help="Compare with given reference_data for plasma tests")
