...
def calculate_mass_fractions_over_time(isotope_mass_fraction, time_coord):
    ...
    # Initialize with the original mass fractions
    current_mass_fractions = isotope_mass_fraction.copy()
    all_isotopes = set(current_mass_fractions.index)
    mass_fractions_list = []

    # Calculate decay for each time step recursively
    for delta_time in delta_times:
        # Use the existing calculate_decayed_mass_fractions method with delta_time
