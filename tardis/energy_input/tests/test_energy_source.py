...
from tardis.energy_input.energy_source import read_nuclear_dataframe, \
    get_gamma_rays_property, create_energy_cdf, sample_energy_distribution, \
...
@pytest.mark.xfail(reason="To be implemented")
def test_get_gamma_rays_property():
    assert False
