...
class TestGrotrianPlot:
    ...
    def test_compute_transitions(self, grotrian_plot, regression_data):
        ...
        pdt.assert_frame_equal(excitation_lines, expected_excitation_lines, rtol=1e-15, atol=0)
        pdt.assert_frame_equal(deexcitation_lines, expected_deexcitation_lines, rtol=1e-15, atol=0)
    ...
    def test_compute_level_data(self, grotrian_plot, regression_data):
        ...
        pdt.assert_frame_equal(level_data, expected_level_data, rtol=1e-15, atol=0)
