...
def line_info_widget(simulation_simple):
    line_info_widget = LineInfoWidget.from_simulation(simulation_simple)
...
class TestLineInfoWidgetEvents:
    ...
    def liw_with_selection(self, simulation_simple, request, monkeysession):
        """
        Makes different wavelength range selection on figure (specified by
        params) after creating a LineInfoWidget object.
        """
        liw = LineInfoWidget.from_simulation(simulation_simple)
