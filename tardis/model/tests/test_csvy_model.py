...
def csvy_model_test_abundances():
    ...
    csvypath = os.path.join(DATA_PATH, "csvy_model_test_abundances.yml")
...
def reference_input_dataframes():
    ...
    `test_read_csvy`.
    Constructed from `csvy_model_test_abundances.yml`
...
def test_read_csvy_abundances(csvy_model_test_abundances,
